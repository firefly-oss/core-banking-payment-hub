...
/**
 * Request for cancelling a TARGET2 payment.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request for cancelling a TARGET2 payment")
public class Target2CancellationRequestDTO {
    ...
    @Schema(description = "Type of payment", required = true, example = "TARGET2")
    ...
    @Schema(description = "Preferred payment provider", example = "TARGET2_PROVIDER")
