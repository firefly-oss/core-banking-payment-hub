...
/**
 * Request for scheduling a SEPA payment.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request for scheduling a SEPA payment")
public class SepaScheduleRequestDTO {
    
    @Valid
    @NotNull(message = "Payment request is required")
    @Schema(description = "The SEPA payment request to schedule", required = true)
    private SepaPaymentRequestDTO paymentRequest;
