...
/**
 * Request for cancelling a TIPS (TARGET Instant Payment Settlement) payment.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request for cancelling a TIPS (TARGET Instant Payment Settlement) payment")
public class TipsCancellationRequestDTO {
    ...
    @Schema(description = "Type of payment", required = true, example = "TIPS")
    private PaymentType paymentType;

    @Schema(description = "Original end-to-end ID of the payment", example = "E2E-12345678")
    private String endToEndId;

    @Schema(description = "Original UETR (Unique End-to-end Transaction Reference)", example = "97ed4827-7b6f-4491-a06f-b548d5a7512d")
    private String uetr;
    ...
    @Schema(description = "Preferred payment provider", example = "TIPS_PROVIDER")
