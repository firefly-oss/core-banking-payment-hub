package com.catalis.core.banking.payments.hub.interfaces.dtos.uk;
...
/**
 * Request for cancelling a UK payment (Faster Payments, BACS, or CHAPS).
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request for cancelling a UK payment (Faster Payments, BACS, or CHAPS)")
public class UkCancellationRequestDTO {
    ...
    @Schema(description = "Type of payment", required = true, example = "UK_FPS")
    ...
    @Schema(description = "Preferred payment provider", example = "UK_PROVIDER")
