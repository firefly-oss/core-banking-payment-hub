...
/**
 * Request for cancelling an internal transfer.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request for cancelling an internal transfer")
public class InternalTransferCancellationRequestDTO {

    @NotBlank(message = "Payment ID is required")
    @Schema(description = "ID of the payment to cancel", example = "INT-12345678", required = true)
    private String paymentId;

    @NotNull(message = "Payment type is required")
    @Schema(description = "Type of payment", required = true, example = "INTERNAL_TRANSFER")
    private PaymentType paymentType;

    @Schema(description = "Source account ID", example = "ACC-12345678")
    private String sourceAccountId;

    @Schema(description = "Destination account ID", example = "ACC-87654321")
    ...
    @Schema(description = "Preferred payment provider", example = "INTERNAL_PROVIDER")
