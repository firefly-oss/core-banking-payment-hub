...
import com.firefly.core.banking.payments.hub.core.utils.CancellationUtils;
...
@Slf4j
@Component
public class DefaultEbaStep2PaymentProvider extends AbstractBasePaymentProvider implements EbaStep2PaymentProvider {
    ...
    protected Mono<Boolean> checkProviderHealth() {
        ...
        log.debug("Checking connectivity to EBA STEP2 payment systems");
